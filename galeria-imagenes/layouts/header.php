            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-md-7 py-4">
                        <h4>Descripción</h4>
                        <p class="text-body-secondary">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Minima dicta totam quia ad modi exercitationem magni quas ipsam, architecto itaque ducimus qui velit dolores provident perferendis at, praesentium laborum laboriosam?</p>
                    </div>
